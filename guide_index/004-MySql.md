...
![01_程序是如何跟mysql打交道的.png](https://img.52javaee.com/blog01_程序是如何跟mysql打交道的.png)
...
![02_mysql架构（2）.png](https://img.52javaee.com/blog02_mysql架构.png)
...
![03_InnoDB存储引擎的架构设计.png](https://img.52javaee.com/blog03_InnoDB存储引擎的架构设计.png)
...
![12_VARCHAR这种变长字段，在磁盘上到底是如何存储的.png](https://img.52javaee.com/blog12_VARCHAR这种变长字段，在磁盘上到底是如何存储的.png)
...
![13_null值列表与数据头.png](https://img.52javaee.com/blog13_null值列表与数据头.png)
...
![14_行溢出.png](https://img.52javaee.com/blog14_行溢出.png)
...
![04_Buffer Pool内存数据结构.png](https://img.52javaee.com/blog04_Buffer Pool内存数据结构.png)
...
![image.png](https://img.52javaee.com/blogfree链表.jpg)
...
![05_free链表和hash表.png](https://img.52javaee.com/blog05_free链表和hash表.png)
...
![06_flush链表和脏数据.png](https://img.52javaee.com/blog06_flush链表和脏数据.png)
...
![07_LRU算法淘汰部分缓存.png](https://img.52javaee.com/blog07_LRU算法淘汰部分缓存.png)
...
![08_LRU链表在Buffer Pool的问题（预读机制）.png](https://img.52javaee.com/blog08_LRU链表在Buffer Pool的问题（预读机制）.png)
...
![09_通过热冷数据分离，优化LRU算法.png](https://img.52javaee.com/blog09_通过热冷数据分离，优化LRU算法.png)

##### 通过定时任务，优化 LRU 算法

为了提升效率，MySQL 开启一个后台线程，定时把冷数据尾部的一些数据输入磁盘。

![10_定时任务，优化LRU算法.png](https://img.52javaee.com/blog10_定时任务，优化LRU算法.png)

### free 链表、flush 链表、LRU 链表，修改数据的动态联系


![11_free链表、flush链表、lru链表，修改数据的动态联系.png](https://img.52javaee.com/blog11_free链表、flush链表、lru链表，修改数据的动态联系.png)
...
![25_redo log通用结构.png](https://img.52javaee.com/blog25_redo log通用结构.png)
...
![image.png](https://img.52javaee.com/blogredolog-block.jpg)

其中 header 存放的内容如下：

![image.png](https://img.52javaee.com/blogredolog-block-head.jpg)

整个 redo log 写入的流程，总结如下：

![24_redo log block.png](https://img.52javaee.com/blog24_redo log block.png)
...
![image.png](https://img.52javaee.com/blogundolog内存结构.jpg)
...
![28_MySQL事务执行流程.png](https://img.52javaee.com/blog28_MySQL事务执行流程.png)

2、MySQL 事务恢复流程

![30_MySQL事务恢复流程.png](https://img.52javaee.com/blog30_MySQL事务恢复流程.png)
...
![在这里插入图片描述](https://img.52javaee.com/blogundolog版本链①.jpg)

 ↓↓↓↓↓↓↓↓↓↓↓↓↓↓↓

![image.png](https://img.52javaee.com/blogundolog版本链②.jpg)
...
![image.png](https://img.52javaee.com/blog15_数据页的各个部分.png)

去除掉一些我们不太需要那么关注的部分后，简化如下：

![image.png](https://img.52javaee.com/blog数据页内存结构.jpg)
...
![image.png](https://img.52javaee.com/blog页分裂①.jpg)
...
![image.png](https://img.52javaee.com/blog索引页存储结构①.jpg)
...
![image.png](https://img.52javaee.com/blog二级索引.jpg)
